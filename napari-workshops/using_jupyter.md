...
2. Activate the `napari-I2K-workshop` conda environment, if you haven't already.

   ```bash
    conda activate napari-I2K-workshop
    ```

   You should see `(napari-I2K-workshop)` to the left of your command prompt. For example it could look something like this:
